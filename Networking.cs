...
namespace CryoRespawn.Sync
{
    public class Networking
    {
        ...
        public void Register()
        {
            ...
            MyAPIGateway.Multiplayer.RegisterSecureMessageHandler(PacketId, ReceivedSecurePacket);
        }
        ...
        public void Unregister()
        {
            ...
            MyAPIGateway.Multiplayer.UnregisterSecureMessageHandler(PacketId, ReceivedSecurePacket);
        }
        private void ReceivedSecurePacket(ushort packetId, byte[] rawData, ulong sender, bool fromServer)
        {
